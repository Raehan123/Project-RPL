                ...
                <div class="container-fluid">
                    ...
                    <div class="page-title-box">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <h2 class="display-6 text-black">Jadwal Bimbingan</h2>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                    ...
                    <div class="page-title-box">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <h2 class="display-6 text-black">Pengajuan Jadwal Bimbingan</h2>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                                        ...
                                        <tbody>
                                            @foreach ($bimbingans as $bmb)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class = "btn btn-success" href = "{{ url('approve_bimbingan', $bmb->id) }}">Approve</a>
                                                        <a class = "btn btn-danger" href = "{{ url('reject_bimbingan', $bmb->id) }}">Reject</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
