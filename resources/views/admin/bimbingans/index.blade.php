        ...
        <div class="main-content">
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    {{-- Start Row --}}
                    <div class="card-body">
                        <a href="{{ route('admin.bimbingans.create') }}" class="btn btn-primary btn-lg">+ Tambah</a>
                                        ...
                                        <tbody>
                                            @foreach ($bimbingans as $bmb)
                                                <tr>
                                                    ...
                                                    <td>{{ $bmb->topik }}</td>
                                                    <td>
                                                        <a href="{{ route('admin.bimbingans.edit', $bmb->id) }}"
                                                        ...
                                                        <form action="{{ route('admin.bimbingans.destroy', $bmb->id) }}"
