        ...
        <div class="main-content">
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    {{-- Start Row --}}
                    <div class="card-body">
                        <a href="{{ route('admin.dosens.create') }}" class="btn btn-primary btn-lg">+ Tambah</a>
                                        ...
                                        <tbody>
                                            @foreach ($dosens as $dsn)
                                                <tr>
                                                    ...
                                                    <td>{{ $dsn->email }}</td>
                                                    <td>
                                                        <a href="{{ route('admin.dosens.edit', $dsn->id) }}"
                                                        ...
                                                        <form action="{{ route('admin.dosens.destroy', $dsn->id) }}"
