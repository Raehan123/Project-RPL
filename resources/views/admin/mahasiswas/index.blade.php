        ...
        <div class="main-content">
            <div class="page-content">
                ` <div class="container-fluid">
                    ...
                    {{-- Start Row --}}
                    <div class="card-body">
                        <a href="{{ route('admin.mahasiswas.create') }}" class="btn btn-primary btn-lg">+ Tambah</a>
                                        ...
                                        <tbody>
                                            @foreach ($mahasiswas as $mhs)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin.mahasiswas.edit', $mhs->id) }}"
                                                        ...
                                                        <form action="{{ route('admin.mahasiswas.destroy', $mhs->id) }}"
