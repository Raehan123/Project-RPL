                            ...
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('dosen.jadwal.store') }}" method="POST">
                                        ...
                                        <div class="form-group row mb-3 align-items-center">
                                            <label for="jam_bimbingan" class="col-2 col-form-label">Jam Pengiriman</label>
                                            <div class="col-10">
                                                <input id="jam_bimbingan" name="jam_bimbingan" type="time" required="required"
                                                    value="{{ \Carbon\Carbon::createFromFormat('H:i:s', $bimbingans->jam_bimbingan)->format('H:i') }}" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3 align-items-center">
                                            ...
                                            <div class="col-10">
                                                <input id="jam" name="jam" type="time" required="required"
                                                    value="{{ \Carbon\Carbon::createFromFormat('H:i:s', $bimbingans->jam)->format('H:i') }}" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3 align-items-center">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <a href="{{ route('dosen.jadwal.index') }}" class="btn btn-danger">Batal</a>
                                        </div>
                                    </form>
                                </div>
